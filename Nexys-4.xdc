...
set_property PACKAGE_PIN E3 [get_ports i_clock_100]							
...
set_property PACKAGE_PIN D18 [get_ports {io_ov7670_sda}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {io_ov7670_sda}]
...
set_property PACKAGE_PIN G14 [get_ports {i_ov7670_read_image_data[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {i_ov7670_read_image_data[0]}]
##Bank = 14, Pin name = IO_L13P_T2_MRCC_14,					Sch name = JB2
set_property PACKAGE_PIN P15 [get_ports {i_ov7670_read_image_data[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {i_ov7670_read_image_data[1]}]
##Bank = 14, Pin name = IO_L21N_T3_DQS_A06_D22_14,			Sch name = JB3
set_property PACKAGE_PIN V11 [get_ports {i_ov7670_read_image_data[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {i_ov7670_read_image_data[2]}]
##Bank = CONFIG, Pin name = IO_L16P_T2_CSI_B_14,				Sch name = JB4
set_property PACKAGE_PIN V15 [get_ports {i_ov7670_read_image_data[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {i_ov7670_read_image_data[3]}]
##Bank = 15, Pin name = IO_25_15,							Sch name = JB7
set_property PACKAGE_PIN K16 [get_ports {i_ov7670_read_image_data[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {i_ov7670_read_image_data[4]}]
##Bank = CONFIG, Pin name = IO_L15P_T2_DQS_RWR_B_14,			Sch name = JB8
set_property PACKAGE_PIN R16 [get_ports {i_ov7670_read_image_data[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {i_ov7670_read_image_data[5]}]
##Bank = 14, Pin name = IO_L24P_T3_A01_D17_14,				Sch name = JB9
set_property PACKAGE_PIN T9 [get_ports {i_ov7670_read_image_data[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {i_ov7670_read_image_data[6]}]
##Bank = 14, Pin name = IO_L19N_T3_A09_D25_VREF_14,			Sch name = JB10 
set_property PACKAGE_PIN U11 [get_ports {i_ov7670_read_image_data[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {i_ov7670_read_image_data[7]}]
